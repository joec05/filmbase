...
import 'package:filmbase/view_movies_list.dart';
                    ...
                    items: [1, 2, 3, 4, 5].map((x) {
                      return Builder(
                        builder: (BuildContext context) {
                          MovieDataClass movieData = appStateClass.globalMovies[lists[i][x]]!.notifier.value;
                          return InkWell(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, x){
                  if(appStateClass.globalMovies[lists[i][x]] == null){
                    return Container();
                  }
                  return ValueListenableBuilder(
                    valueListenable: appStateClass.globalMovies[lists[i][x]]!.notifier,
