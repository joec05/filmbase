...
import 'package:filmbase/view_tv_shows_list.dart';
                    ...
                    items: [1, 2, 3, 4, 5].map((x) {
                      return Builder(
                        builder: (BuildContext context) {
                          TvSeriesDataClass tvShowData = appStateClass.globalTvSeries[lists[i][x]]!.notifier.value;
                          return InkWell(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, x){
                  if(appStateClass.globalTvSeries[lists[i][x]] == null){
                    return Container();
                  }
                  return ValueListenableBuilder(
                    valueListenable: appStateClass.globalTvSeries[lists[i][x]]!.notifier,
