                      ...
                      SizedBox(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, i){
                            ...
                            MovieDataClass movieData = appStateClass.globalMovies[searchedItems[i].id]!.notifier.value;
                            return Container(
                      ...
                      SizedBox(
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, i){
                            ...
                            TvSeriesDataClass tvShowData = appStateClass.globalTvSeries[searchedItems[i].id]!.notifier.value;
                            return Container(
                              width: basicCoverDisplayWidgetSize.width,
                              padding: EdgeInsets.only(
                                right: defaultHorizontalPadding
                  ...
                  child: SizedBox(
                    child: Column(
                      ...
                      children: [
                        ...
                        appStateClass.currentUserData!.username == listData.creator ?
                          Row(
                            children: [
                              InkWell(
