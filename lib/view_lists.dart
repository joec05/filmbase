...
import 'package:filmbase/custom/custom_list_display.dart';
...
class _ViewListsStatefulState extends State<ViewListsStateful>{
  ...
  void fetchLists(int page) async{
    List<int> getListsData = await runFetchAPI(
      '$mainAPIUrl/account/${appStateClass.apiIdentifiers.userID}/lists?page=$page'
    );
          ...
          child: CustomScrollView(
            ...
            slivers: <Widget>[
              SliverList(delegate: SliverChildBuilderDelegate(
                ...
                (c, i) {
                  if(appStateClass.globalLists[lists[i]] == null){
                    return Container();
                  }
                  return ValueListenableBuilder(
                    valueListenable: appStateClass.globalLists[lists[i]]!.notifier,
